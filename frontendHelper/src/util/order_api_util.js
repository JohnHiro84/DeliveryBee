...
export const getAvailableOrders = () => {
  return axios.get('/api/orders/helper/available')
};

export const getHelperOrders = id => {
  return axios.get(`/api/orders/helper/${id}`)
};

export const getHelperOrdersCompleted = id => {
  return axios.get(`/api/orders/helper/completed/${id}`)
};

export const getHelperOrdersAccepted = id => {
  return axios.get(`/api/orders/helper/accepted/${id}`)
};
...
export const updateOrderCompletedUtil = (id) => {
  ...
  return axios.put(`api/orders/completed/${id}`,
    {
